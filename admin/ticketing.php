...
<form class="form-horizontal" action="" method="post" >
						...
						<select name="date_created" id="date_created" >
							<?php 
							$book = $conn->query("SELECT distinct date_created FROM ticket_details order by date_created asc");
							while($row = $book->fetch_assoc()):
							?>
								<option><?php echo date("Y-m-d",strtotime($row['date_created']))?></option>
