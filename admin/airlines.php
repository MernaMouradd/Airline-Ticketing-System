...
<script>
	...
	/*$('.edit_airline').click(function(){
		...
		//cat.find("[name='logo_path']").attr("src","../assets/img/"+$(this).attr('data-logo_path'))

		cat.find("[name='img']").val($(this).attr('data-logo_path'))
		cat.find("#cimg").attr("src","../assets/img/"+$(this).attr('data-logo_path'))
		//cat.find("[name='img']").val($(this).attr('data-logo_path'))
		//cat.find("[name='cimg']").val($(this).attr('data-logo_path'))
		// reader.readAsDataURL(cat.find("[name='img']").val($(this).attr('data-logo_path')))
		cat.find("[name='package_weight']").val($(this).attr('data-package_weight'))
		cat.find("[name='package_width']").val($(this).attr('data-package_width'))
		cat.find("[name='package_height']").val($(this).attr('data-package_height'))
		end_load()
	})*/
